...
func (u *UpdateInfo) WalkItem(f func(d *gamedata.ResourceItemData, amount uint64)) error {
...
func (u *UpdateInfo) WalkPack(f func(d *gamedata.ResourcePackData, amount uint64)) error {
