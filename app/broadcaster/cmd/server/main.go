...
func init() {
	flag.StringVar(&flagConf, "conf", "app/broadcaster/configs", "config path, eg: -conf config.yaml")
	flag.StringVar(&flagGamedata, "gamedata", "gen/gamedata/json", "gamedata path, eg: -gamedata gamedata.json")
}
