...
type Data struct {
	...
	RouteTableAliveDuration *durationpb.Duration   `protobuf:"bytes,2,opt,name=route_table_alive_duration,json=routeTableAliveDuration,proto3" json:"route_table_alive_duration,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_conf_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"conf.proto\x12\x19broadcaster.internal.conf\x1a\x1egoogle/protobuf/duration.proto\"\x9d\x02\n" +
	"\tBootstrap\x126\n" +
	"\x05label\x18\x01 \x01(\v2 .broadcaster.internal.conf.LabelR\x05label\x126\n" +
	"\x05trace\x18\x02 \x01(\v2 .broadcaster.internal.conf.TraceR\x05trace\x129\n" +
	"\x06server\x18\x03 \x01(\v2!.broadcaster.internal.conf.ServerR\x06server\x123\n" +
	"\x04data\x18\x04 \x01(\v2\x1f.broadcaster.internal.conf.DataR\x04data\x120\n" +
	"\x03log\x18\x05 \x01(\v2\x1e.broadcaster.internal.conf.LogR\x03log\"\xaf\x01\n" +
	"\x05Label\x12\x18\n" +
	...
	"\x05level\x18\x02 \x01(\tR\x05level\"\xee\x02\n" +
	"\x06Server\x12:\n" +
	"\x04http\x18\x01 \x01(\v2&.broadcaster.internal.conf.Server.HTTPR\x04http\x12:\n" +
	"\x04grpc\x18\x02 \x01(\v2&.broadcaster.internal.conf.Server.GRPCR\x04grpc\x12\x16\n" +
	...
	"\x04Data\x12;\n" +
	"\x05redis\x18\x01 \x01(\v2%.broadcaster.internal.conf.Data.RedisR\x05redis\x12V\n" +
	"\x1aroute_table_alive_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x17routeTableAliveDuration\x1a\x8d\x02\n" +
	"\x05Redis\x12\x12\n" +
	...
	"\bRegistry\x123\n" +
	"\x04etcd\x18\x01 \x01(\v2\x1f.broadcaster.internal.conf.EtcdR\x04etcd\"\\\n" +
	"\x04Etcd\x12\x1c\n" +
	"\tendpoints\x18\x01 \x03(\tR\tendpoints\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpasswordB$Z\"app/broadcaster/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	(*Bootstrap)(nil),           // 0: broadcaster.internal.conf.Bootstrap
	(*Label)(nil),               // 1: broadcaster.internal.conf.Label
	(*Trace)(nil),               // 2: broadcaster.internal.conf.Trace
	(*Log)(nil),                 // 3: broadcaster.internal.conf.Log
	(*Server)(nil),              // 4: broadcaster.internal.conf.Server
	(*Data)(nil),                // 5: broadcaster.internal.conf.Data
	(*Registry)(nil),            // 6: broadcaster.internal.conf.Registry
	(*Etcd)(nil),                // 7: broadcaster.internal.conf.Etcd
	(*Server_HTTP)(nil),         // 8: broadcaster.internal.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 9: broadcaster.internal.conf.Server.GRPC
	(*Data_Redis)(nil),          // 10: broadcaster.internal.conf.Data.Redis
	(*durationpb.Duration)(nil), // 11: google.protobuf.Duration
}
var file_conf_proto_depIdxs = []int32{
	1,  // 0: broadcaster.internal.conf.Bootstrap.label:type_name -> broadcaster.internal.conf.Label
	2,  // 1: broadcaster.internal.conf.Bootstrap.trace:type_name -> broadcaster.internal.conf.Trace
	4,  // 2: broadcaster.internal.conf.Bootstrap.server:type_name -> broadcaster.internal.conf.Server
	5,  // 3: broadcaster.internal.conf.Bootstrap.data:type_name -> broadcaster.internal.conf.Data
	3,  // 4: broadcaster.internal.conf.Bootstrap.log:type_name -> broadcaster.internal.conf.Log
	8,  // 5: broadcaster.internal.conf.Server.http:type_name -> broadcaster.internal.conf.Server.HTTP
	9,  // 6: broadcaster.internal.conf.Server.grpc:type_name -> broadcaster.internal.conf.Server.GRPC
	10, // 7: broadcaster.internal.conf.Data.redis:type_name -> broadcaster.internal.conf.Data.Redis
	11, // 8: broadcaster.internal.conf.Data.route_table_alive_duration:type_name -> google.protobuf.Duration
	7,  // 9: broadcaster.internal.conf.Registry.etcd:type_name -> broadcaster.internal.conf.Etcd
	11, // 10: broadcaster.internal.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	11, // 11: broadcaster.internal.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	11, // 12: broadcaster.internal.conf.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	11, // 13: broadcaster.internal.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	11, // 14: broadcaster.internal.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
