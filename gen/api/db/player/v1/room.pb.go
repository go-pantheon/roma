...
const file_player_v1_room_proto_rawDesc = "" +
	"\n" +
	"\x14player/v1/room.proto\x12\tplayer.v1\">\n" +
	"\rUserRoomProto\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1d\n" +
	"\n" +
	"is_creator\x18\x02 \x01(\bR\tisCreatorB\x17Z\x15api/db/player/v1;dbv1b\x06proto3"
